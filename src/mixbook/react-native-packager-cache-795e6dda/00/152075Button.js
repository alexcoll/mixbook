...
var _ReactNativePropRegistry=require('react-native/Libraries/Renderer/src/renderers/native/ReactNativePropRegistry');var _ReactNativePropRegistry2=babelHelpers.interopRequireDefault(_ReactNativePropRegistry);var


Button=function(_NativeBaseComponent){babelHelpers.inherits(Button,_NativeBaseComponent);function Button(){babelHelpers.classCallCheck(this,Button);return babelHelpers.possibleConstructorReturn(this,(Button.__proto__||Object.getPrototypeOf(Button)).apply(this,arguments));}babelHelpers.createClass(Button,[{key:'getInitialStyle',value:function getInitialStyle()
...
if(this.props.children.type==_Icon2.default){
...
{var _this2=this;
return(
_react2.default.createElement(_reactNative.TouchableOpacity,babelHelpers.extends({ref:function ref(c){return _this2._root=c;}},this.prepareRootProps(),{activeOpacity:0.5}),
this.renderChildren()));
