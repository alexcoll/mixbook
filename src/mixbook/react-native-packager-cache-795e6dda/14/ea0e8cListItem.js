...
var _Thumbnail=require('./Thumbnail');var _Thumbnail2=babelHelpers.interopRequireDefault(_Thumbnail);
var _Checkbox=require('./Checkbox');var _Checkbox2=babelHelpers.interopRequireDefault(_Checkbox);
var _Picker=require('./Picker');var _Picker2=babelHelpers.interopRequireDefault(_Picker);
var _Radio=require('./Radio');var _Radio2=babelHelpers.interopRequireDefault(_Radio);
var _InputGroup=require('./InputGroup');var _InputGroup2=babelHelpers.interopRequireDefault(_InputGroup);
var _lodash=require('lodash');var _lodash2=babelHelpers.interopRequireDefault(_lodash);var

ListItemNB=function(_NativeBaseComponent){babelHelpers.inherits(ListItemNB,_NativeBaseComponent);function ListItemNB(){babelHelpers.classCallCheck(this,ListItemNB);return babelHelpers.possibleConstructorReturn(this,(ListItemNB.__proto__||Object.getPrototypeOf(ListItemNB)).apply(this,arguments));}babelHelpers.createClass(ListItemNB,[{key:'getInitialStyle',value:function getInitialStyle()
...
_react2.default.Children.forEach(this.props.children,function(child){
if(child&&child.type==_Radio2.default)
...
_react2.default.Children.forEach(this.props.children,function(child){
if(child&&child.type==_Picker2.default)
...
_react2.default.Children.forEach(this.props.children,function(child){
if(child&&child.type==_Badge2.default)
...
_react2.default.Children.forEach(this.props.children,function(child){
if(child&&child.type==_InputGroup2.default)
...
if(child&&child.type==_reactNative.Image&&!Array.isArray(this.props.children)){
defaultProps={
resizeMode:'stretch',
...
if(child&&child.type==_Text2.default){
...
_react2.default.Children.forEach(this.props.children,function(child){
if(child&&child.type==_InputGroup2.default&&child.props.inset)
insetPresent=true;
});
...
newChildren.push(_react2.default.cloneElement(iconElement[0],babelHelpers.extends({},this.getChildProps(iconElement[0]),{key:'listItem0'})));
...
return _react2.default.cloneElement(child,babelHelpers.extends({},_this2.getChildProps(child),{key:i}));
})));
...
newChildren.push(_react2.default.cloneElement(pickerElement[0],babelHelpers.extends({},this.getChildProps(pickerElement[0]),{key:'listItem1',style:{flex:1,alignSelf:'flex-end'}})));
}else
...
newChildren.push(_react2.default.cloneElement(iconElement[0],babelHelpers.extends({},this.getChildProps(iconElement[0]),{key:'listItem1'})));
}else
...
newChildren.push(_react2.default.cloneElement(badgeElement[0],babelHelpers.extends({},this.getChildProps(badgeElement[0]),{key:'listItem1'})));
}else
...
newChildren.push(_react2.default.cloneElement(iconElement[1],babelHelpers.extends({},this.getChildProps(iconElement[1]),{key:'listItem1'})));
}else
...
newChildren.push(_react2.default.createElement(_View2.default,{key:'listItem0',style:{flexDirection:'row',justifyContent:'center',flex:1,borderColor:this.getTheme().listBorderColor,alignItems:'center',height:this.getTheme().inputHeightBase}},
...
childrenArray.map(function(child,i){
return _react2.default.cloneElement(child,babelHelpers.extends({},_this2.getChildProps(child),{key:i,style:{borderWidth:0}}));
})));
...
childrenArray.map(function(child,i){
return _react2.default.cloneElement(child,babelHelpers.extends({},_this2.getChildProps(child),{key:i,style:{flex:1}}));
})));
...
{var _this3=this;
return(
_react2.default.createElement(_reactNative.TouchableOpacity,babelHelpers.extends({ref:function ref(c){return _this3._root=c;}},this.prepareRootProps(),{activeOpacity:this.props.button?0.2:1}),
this.renderChildren()));
