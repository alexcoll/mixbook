...
}babelHelpers.createClass(CardSwiper,[{key:'getInitialStyle',value:function getInitialStyle()
...
return(
_react2.default.createElement(_View2.default,{ref:function ref(c){return _this6._root=c;},style:{position:'relative',flexDirection:'column'}},this.state.selectedItem===undefined?_react2.default.createElement(_View2.default,null):
_react2.default.createElement(_View2.default,null,
_react2.default.createElement(_reactNative.Animated.View,babelHelpers.extends({style:[this.getCardStyles()[1],this.getInitialStyle().topCard,{opacity:this.state.fadeAnim}]},this._panResponder.panHandlers),
...
_react2.default.createElement(_reactNative.Animated.View,babelHelpers.extends({style:[this.getCardStyles()[0],this.getInitialStyle().topCard]},this._panResponder.panHandlers),
